 ...
 */
@Entity
@Table(name = "years", catalog = "irish_crime", schema = "")
@NamedQueries({
    ...
    , @NamedQuery(name = "Years.findByQ1", query = "SELECT y FROM Years y WHERE y.q1 = :q1")
    , @NamedQuery(name = "Years.findByQ2", query = "SELECT y FROM Years y WHERE y.q2 = :q2")
    , @NamedQuery(name = "Years.findByQ3", query = "SELECT y FROM Years y WHERE y.q3 = :q3")
    , @NamedQuery(name = "Years.findByQ4", query = "SELECT y FROM Years y WHERE y.q4 = :q4")
    , @NamedQuery(name = "Years.findByQ11", query = "SELECT y FROM Years y WHERE y.q11 = :q11")
    , @NamedQuery(name = "Years.findByQ21", query = "SELECT y FROM Years y WHERE y.q21 = :q21")
    , @NamedQuery(name = "Years.findByQ31", query = "SELECT y FROM Years y WHERE y.q31 = :q31")
    , @NamedQuery(name = "Years.findByQ41", query = "SELECT y FROM Years y WHERE y.q41 = :q41")
    , @NamedQuery(name = "Years.findByQ12", query = "SELECT y FROM Years y WHERE y.q12 = :q12")
    , @NamedQuery(name = "Years.findByQ22", query = "SELECT y FROM Years y WHERE y.q22 = :q22")
    , @NamedQuery(name = "Years.findByQ32", query = "SELECT y FROM Years y WHERE y.q32 = :q32")
    , @NamedQuery(name = "Years.findByQ42", query = "SELECT y FROM Years y WHERE y.q42 = :q42")
    , @NamedQuery(name = "Years.findByQ13", query = "SELECT y FROM Years y WHERE y.q13 = :q13")
    , @NamedQuery(name = "Years.findByQ23", query = "SELECT y FROM Years y WHERE y.q23 = :q23")
    , @NamedQuery(name = "Years.findByQ33", query = "SELECT y FROM Years y WHERE y.q33 = :q33")
    , @NamedQuery(name = "Years.findByQ43", query = "SELECT y FROM Years y WHERE y.q43 = :q43")
    , @NamedQuery(name = "Years.findByQ14", query = "SELECT y FROM Years y WHERE y.q14 = :q14")
    , @NamedQuery(name = "Years.findByQ24", query = "SELECT y FROM Years y WHERE y.q24 = :q24")
    , @NamedQuery(name = "Years.findByQ34", query = "SELECT y FROM Years y WHERE y.q34 = :q34")
    , @NamedQuery(name = "Years.findByQ44", query = "SELECT y FROM Years y WHERE y.q44 = :q44")
    , @NamedQuery(name = "Years.findByQ15", query = "SELECT y FROM Years y WHERE y.q15 = :q15")
    , @NamedQuery(name = "Years.findByQ25", query = "SELECT y FROM Years y WHERE y.q25 = :q25")
    , @NamedQuery(name = "Years.findByQ35", query = "SELECT y FROM Years y WHERE y.q35 = :q35")
    , @NamedQuery(name = "Years.findByQ45", query = "SELECT y FROM Years y WHERE y.q45 = :q45")
    , @NamedQuery(name = "Years.findByQ16", query = "SELECT y FROM Years y WHERE y.q16 = :q16")
    , @NamedQuery(name = "Years.findByQ26", query = "SELECT y FROM Years y WHERE y.q26 = :q26")
    , @NamedQuery(name = "Years.findByQ36", query = "SELECT y FROM Years y WHERE y.q36 = :q36")
    , @NamedQuery(name = "Years.findByQ46", query = "SELECT y FROM Years y WHERE y.q46 = :q46")
    , @NamedQuery(name = "Years.findByQ17", query = "SELECT y FROM Years y WHERE y.q17 = :q17")
    , @NamedQuery(name = "Years.findByQ27", query = "SELECT y FROM Years y WHERE y.q27 = :q27")
    , @NamedQuery(name = "Years.findByQ37", query = "SELECT y FROM Years y WHERE y.q37 = :q37")
    , @NamedQuery(name = "Years.findByQ47", query = "SELECT y FROM Years y WHERE y.q47 = :q47")
    , @NamedQuery(name = "Years.findByQ18", query = "SELECT y FROM Years y WHERE y.q18 = :q18")
    , @NamedQuery(name = "Years.findByQ28", query = "SELECT y FROM Years y WHERE y.q28 = :q28")
    , @NamedQuery(name = "Years.findByQ38", query = "SELECT y FROM Years y WHERE y.q38 = :q38")
    , @NamedQuery(name = "Years.findByQ48", query = "SELECT y FROM Years y WHERE y.q48 = :q48")
    , @NamedQuery(name = "Years.findByQ19", query = "SELECT y FROM Years y WHERE y.q19 = :q19")
    , @NamedQuery(name = "Years.findByQ29", query = "SELECT y FROM Years y WHERE y.q29 = :q29")
    , @NamedQuery(name = "Years.findByQ39", query = "SELECT y FROM Years y WHERE y.q39 = :q39")
    , @NamedQuery(name = "Years.findByQ49", query = "SELECT y FROM Years y WHERE y.q49 = :q49")
    , @NamedQuery(name = "Years.findByQ110", query = "SELECT y FROM Years y WHERE y.q110 = :q110")
    , @NamedQuery(name = "Years.findByQ210", query = "SELECT y FROM Years y WHERE y.q210 = :q210")
    , @NamedQuery(name = "Years.findByQ310", query = "SELECT y FROM Years y WHERE y.q310 = :q310")
    , @NamedQuery(name = "Years.findByQ410", query = "SELECT y FROM Years y WHERE y.q410 = :q410")
    , @NamedQuery(name = "Years.findByQ111", query = "SELECT y FROM Years y WHERE y.q111 = :q111")
    , @NamedQuery(name = "Years.findByQ211", query = "SELECT y FROM Years y WHERE y.q211 = :q211")
    , @NamedQuery(name = "Years.findByQ311", query = "SELECT y FROM Years y WHERE y.q311 = :q311")
    , @NamedQuery(name = "Years.findByQ411", query = "SELECT y FROM Years y WHERE y.q411 = :q411")
    , @NamedQuery(name = "Years.findByQ112", query = "SELECT y FROM Years y WHERE y.q112 = :q112")
    , @NamedQuery(name = "Years.findByQ212", query = "SELECT y FROM Years y WHERE y.q212 = :q212")
    , @NamedQuery(name = "Years.findByQ312", query = "SELECT y FROM Years y WHERE y.q312 = :q312")
    , @NamedQuery(name = "Years.findByQ412", query = "SELECT y FROM Years y WHERE y.q412 = :q412")
    , @NamedQuery(name = "Years.findByQ113", query = "SELECT y FROM Years y WHERE y.q113 = :q113")
    , @NamedQuery(name = "Years.findByQ213", query = "SELECT y FROM Years y WHERE y.q213 = :q213")
    , @NamedQuery(name = "Years.findByQ313", query = "SELECT y FROM Years y WHERE y.q313 = :q313")
    , @NamedQuery(name = "Years.findByQ413", query = "SELECT y FROM Years y WHERE y.q413 = :q413")
    , @NamedQuery(name = "Years.findByQ114", query = "SELECT y FROM Years y WHERE y.q114 = :q114")
    , @NamedQuery(name = "Years.findByQ214", query = "SELECT y FROM Years y WHERE y.q214 = :q214")
    , @NamedQuery(name = "Years.findByQ314", query = "SELECT y FROM Years y WHERE y.q314 = :q314")
    , @NamedQuery(name = "Years.findByQ414", query = "SELECT y FROM Years y WHERE y.q414 = :q414")
    , @NamedQuery(name = "Years.findByQ115", query = "SELECT y FROM Years y WHERE y.q115 = :q115")
    , @NamedQuery(name = "Years.findByQ215", query = "SELECT y FROM Years y WHERE y.q215 = :q215")
    , @NamedQuery(name = "Years.findByQ315", query = "SELECT y FROM Years y WHERE y.q315 = :q315")
    , @NamedQuery(name = "Years.findByQ415", query = "SELECT y FROM Years y WHERE y.q415 = :q415")
    , @NamedQuery(name = "Years.findByQ116", query = "SELECT y FROM Years y WHERE y.q116 = :q116")
    , @NamedQuery(name = "Years.findByQ216", query = "SELECT y FROM Years y WHERE y.q216 = :q216")
    , @NamedQuery(name = "Years.findByQ316", query = "SELECT y FROM Years y WHERE y.q316 = :q316")})
public class Years implements Serializable {
    ...
    public String toString() {
        return "applications5.Years[ yearID=" + yearID + " ]";
    }
